...
if __name__ == '__main__':
    ...
    _search_url = ("__refresh__=true&_extra=&ad_resource=5654&category_id=&context=&dynamic_offset=0&from_source"
                   "=&from_spmid=333.337&gaia_vtoken=&highlight=1&keyword=python&order=click&page=1&page_size=20"
                   "&platform=pc&qv_id=OQ8f2qtgYdBV1UoEnqXUNUl8LEDAdzsD&search_type=video&single_column=0&source_tag"
                   "=3&web_location=1430654")
    _req_data = dict()
